...
| Library sizing signal (0.3.0) | `agent-spec audit --spec-dir docs --format json` | Counts of rules/scenarios/unproven-rules/open-questions to weight remaining effort |
...
```bash
agent-spec contract docs/features/<goal>/spec.md
```
